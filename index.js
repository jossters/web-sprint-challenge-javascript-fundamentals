...
function summation() {
    const totalNumbers = numbers.reduce((acc, item) => acc + item, 0);
     return totalNumbers;
...
const zooAnimals = [
  ...
  */
  function lowerCaseNames(){
    const lower = zooAnimals.map(function(zooAnimal){
  ...
  */
  function lowPopulationAnimals(){
    const filter = zooAnimals.filter(function(zooAnimal){
  ...
  */
  function USApop(){
    const total = zooAnimals.reduce(function(acc, item){
